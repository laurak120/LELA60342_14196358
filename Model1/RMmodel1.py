...
y_int_sentiment = torch.tensor(y_int_sentiment_test.toarray() if hasattr(y_int_sentiment_test, 'toarray') else y_int_sentiment_test, dtype = torch.float32)
...
plt.ylabel("loss")
plt.savefig("lossmodel1.png", dpi=300)
plt.show()
